...
In Figure~\ref{transit} is described the architecture of a transiting exoplanet. When the planet passes in front of its star produced a dimming in its flux called primary transit. The maximum drop during the transit event defines the transit depth $\Delta{F}$:
