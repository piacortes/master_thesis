...
\auspicio{Departamento de Postgrado y Postítulo de la Virrectoría de Asuntos Académicos de la Universidad de Chile}
% ----------------------------------------------------------------------
...
\begin{appendices}
\input{pipeline.tex} 	     % especificaciones del NAO
